export const termsData = [
  ...
  },
  {
    name: 'Abrasive Media',
    definition:
      'The material used in abrasive blasting to remove surface contaminants. Examples of abrasive media are sand, iron shot, crushed iron slag, glass beads, or ground nutshells.'
  },
  {
    name: 'Accelerated Weathering',
    definition:
      'A test designed to simulate but&nbsp;simultaneously intensify and accelerate the destructive action of natural outdoor weathering.'
  },
  {
    name: 'Accelerator',
    definition:
  ...
  },
  {
    name: 'ASTM B 117',
    definition:
      'Salt Fog Spray - Atomized 5% sodium chloride solution at 95°F (35°C).'
  },
  {
    name: 'ASTM D 4258 - 83',
    definition:
  ...
  },
  {
    name: 'Barrier Coat',
    definition:
      'A coating used to isolate a paint system either from the surface to which it is applied or a previous coating to increase adhesion or ensure compatibility.'
  },
  {
    name: 'Binder',
    definition:
  ...
  },
  {
    name: 'Blast Profile',
    definition:
      'A cross-sectional view of an abrasive blasted surface. See also: Anchor Pattern.'
  },
  {
    name: 'Bleaching',
    definition:
      'The fading of a color toward white generally caused by exposure to chemicals\nor ultraviolet radiation.'
  },
  {
    name: 'Bleeding',
    definition:
  ...
  },
  {
    name: 'Blushing',
    definition:
      'A film defect which manifests itself as a milky appearance that is generally caused by rapid solvent evaporation or the presence of excessive moisture during the curing process.'
  },
  {
    name: 'Bonding',
    definition:
  ...
  },
  {
    name: 'Bubbling',
    definition:
      'A temporary or permanent film defect in which air or solvent vapor bubbles are present in the applied film. Often caused by coating over porous surfaces (concrete, IOZ’s, rust), coating over hot substrates, or a solvent evaporating too fast. Not necessarily harmful, especially if the coating flows back together and forms a continuous film.'
  },
  {
    name: 'Build',
  ...
  },
  {
    name: 'Checking',
    definition:
      'Cracks in the surface of a paint film.&nbsp;Often caused by poor flexibility of the topcoat, excessive DFT, or excessive service temperature. Typically seen with alkyd (oil-based) coatings.'
  },
  {
    name: 'Chipping',
    definition:
  ...
  },
  {
    name: 'Clean and Dry',
    definition:
      'Rather than a method, the requirement for Clean and Dry describes the surface condition before painting. The surface shall be clean, dry, and free of oil, grease, wax, form oils, and any other contaminant that may affect the adhesion of the coating.'
  },
  {
    name: 'Cleaners',
    definition:
  ...
  },
  {
    name: 'Cracking',
    definition:
      'Splitting of a paint film usually due to aging. Often caused by excessive film thickness and insufficient dry time between coats, limited coating flexibility, or a substrate that is too hot or too cold when sprayed.'
  },
  {
    name: 'Craters',
  ...
  },
  {
    name: 'Diluent',
    definition:
      'A portion of the volatile components of a coating which is not a true solvent and has minimal effect on the viscosity.'
  },
  {
    name: 'Dispersion',
    definition:
  ...
  },
  {
    name: 'Drier',
    definition:
      'A chemical that promotes oxidation and subsequent drying of a paint film. Primarily used in oil-based paints.'
  },
  {
    name: 'Dry Fall',
    definition:
  ...
  },
  {
    name: 'Dry to Recoat',
    definition:
      'The time required for a cured film to dry before the application of a second coat.'
  },
  {
  ...
  },
  {
    name: 'Elcometer',
    definition:
      'A trademark and brand name for a magnetic instrument for measuring the dry film thickness of coatings applied to ferrous surfaces such as steel.'
  },
  {
  ...
  },
  {
    name: 'Emulsion',
    definition:
      'A two-phase liquid system in which tiny droplets of one liquid are immiscible in and dispersed uniformly throughout a second continuous liquid phase.'
  },
  {
    name: 'Enamel',
    definition:
      'A term used to characterize a coating that has a glossy smooth finish. A common term for alkyd coatings.'
  },
  {
    name: 'Epoxy',
    definition:
  ...
  },
  {
    name: 'Etching',
    definition:
      'The treatment of a surface with an acid to dissolve loose particles or provide a profile.'
  },
  {
    name: 'External Atomization',
    definition:
      'The use of air to break up a coating material after it has exited the spray gun nozzle.'
  },
  {
    name: 'Fading',
  ...
  },
  {
    name: 'Feather Edge',
    definition:
      'Reduced film thickness at the edge of a dry paint film to produce a smooth, continuous appearance.'
  },
  {
    name: 'Ferrous',
  ...
  },
  {
    name: 'Flammable',
    definition:
      'Any substance easily ignited in the presence of a flame; any liquid having a flashpoint below 100°F (37.8°C).'
  },
  {
    name: 'Flash Point',
    definition:
  ...
  },
  {
    name: 'Flexibility',
    definition:
      'The degree to which a coating can conform to movement or deformation of its supporting surface without cracking or flaking.'
  },
  {
    name: 'Floating (Flooding)',
    definition:
      'A concentration of one of the ingredients of the pigmented portion of a paint at its surface giving rise to a color change.'
  },
  {
    name: 'Flow',
    definition:
      'The degree to which a wet paint film can level out after application so as to eliminate brush marks and produce a smooth uniform finish.'
  },
  {
    name: 'Fluid Tip',
  ...
  },
  {
    name: 'Fluorescent',
    definition:
      'A class of pigments that, when exposed to visible light, emit light of a different wavelength producing a bright appearance.'
  },
  {
    name: 'Force Drying',
    definition:
  ...
  },
  {
    ...
    definition:
      "Any thinner not recommended on the label or in the published literature of the manufacturer, which can affect the coating's performance."
  },
  {
    name: 'Fouling',
    definition:
  ...
  },
  {
    name: 'Fungicide',
    definition:
      'A substance poisonous to fungi that retards or kills mold and mildew growth.'
  },
  {
    name: 'Galvanic Anode',
    definition:
      'A metal that, when properly connected to metallic structures of different compositions, will generate an electric current.'
  },
  {
  ...
  },
  {
    name: 'Gelled',
    definition:
      'A coating that has thickened to a jelly-like consistency making it unusable.'
  },
  {
    name: 'Generic',
  ...
  },
  {
    ...
    definition:
      'Steel that has been formed while still hot, generally characterized by the presence of a bluish-black mill scale.'
  },
  {
    name: 'Hydrocarbon',
    definition:
  ...
  },
  {
    name: 'Hydrophobic',
    definition:
      'A substance that does not absorb or exhibit an affinity for water.'
  },
  {
    name: 'Immersion',
    definition:
      'Refers to an environment that is continuously submerged in a liquid, often water.'
  },
  {
  ...
  },
  {
    name: 'Induction Time',
    definition:
      'The time between the mixing of two-component products and the moment they can be used.'
  },
  {
    name: 'Inert Pigment',
  ...
  },
  {
    ...
    definition:
      'A pigment that assists in the prevention of the corrosion process.'
  },
  {
    name: 'Inorganic',
  ...
  },
  {
    name: 'Inorganic Zinc',
    definition:
      'A&nbsp;coating based on a silicate resin and pigmented with metallic zinc that has excellent resistance to organic solvents and general weathering.'
  },
  {
  ...
  },
  {
    ...
    definition:
      'A&nbsp;fire retardant coating that, when heated, produces nonflammable gasses which are trapped by the film, converting it to foam and thereby insulating the substrate.'
  },
  {
    name: 'Ion',
    definition:
      'An atom or group of atoms possessing a positive or negative electric charge resulting from having lost or gained an electron.'
  },
  {
    name: 'Iron Oxide',
  ...
  },
  {
    name: 'Lacquer',
    definition:
      'A coating comprised of a synthetic film-forming material dissolved in organic solvents and dried by solvent evaporation.'
  },
  {
    name: 'Lacquer Thinner',
    definition:
      'A commonly used term to describe a solvent blend of ethyl alcohol, ethyl acetate, and toluene.'
  },
  {
    name: 'Laitance',
    definition:
  ...
  },
  {
    name: 'Latex',
    definition:
      'A stable dispersion of a polymer substance in an aqueous medium. It is a common term for water-reducible coatings.'
  },
  {
    name: 'Lead-Free',
    definition:
  ...
  },
  {
    name: 'Lifting',
    definition:
      'Softening and raising or wrinkling a previous coat by applying an additional coat. It is often caused by coatings containing strong solvents.'
  },
  {
    name: 'Mastic',
  ...
  },
  {
    ...
    definition:
      'A low boiling, highly volatile flammable solvent with excellent solubility for most vinyls, urethanes, and other coatings.'
  },
  {
  ...
  },
  {
    name: 'MIL',
    definition:
      'One&nbsp;one-thousandth of an inch; 0.0001 inches. It is commonly used to denote coating thickness.'
  },
  {
    name: 'Mildew',
    definition:
      'A superficial growth of living organic matter produced by fungi in the presence of moisture. It results in discoloration and decomposition of the surface.'
  },
  {
    name: 'Mill Scale',
    definition:
      'A layer of iron oxide formed on the surface of steel plates during hot rolling. It is bluish in appearance.'
  },
  {
    name: 'Mineral Spirit',
    definition:
      'A&nbsp;refined petroleum distillate with low aromatic hydrocarbon content and low solubility. It is suitable for thinning alkyd coatings.'
  },
  {
    name: 'Miscible',
  ...
  },
  {
    name: 'Mottled',
    definition:
      'Spots of different tones and colors, resulting in a blotchy effect on the coating film.'
  },
  {
    name: 'Mudcraking',
    definition:
  ...
  },
  {
    name: 'Non-Drying Oil',
    definition:
      'Oil that undergoes little or no oxidation when exposed to air and therefore has no film-forming properties.'
  },
  {
    name: 'Nonferrous',
    definition:
      'A&nbsp;term used to designate metals or alloys that do not contain iron.'
  },
  {
    name: 'Nonflammable',
  ...
  },
  {
    name: 'Oil Length',
    definition:
      'The ratio of oil to resin expressed as a percentage of oil by weight in the resin. It is used to determine the physical properties of a resin.'
  },
  {
    name: 'Opacity',
    definition:
  ...
  },
  {
    name: 'Oxidation',
    definition:
      'The formation of an oxide. It is the curing mechanism for alkyds.'
  },
  {
    name: 'Paint',
    definition:
      '(Verb) To apply a thin coating layer to a substrate by brush, roller, spray, or other suitable methods. (Noun) A pigmented liquid designed for application to a substrate in a thin layer, which is then converted to a solid film.'
  },
  {
    name: 'Pass',
  ...
  },
  {
    name: 'Paste',
    definition:
      'The product of a dispersion process. It is usually a very high viscosity and requires dilution before application. It is a concentrated pigment dispersion used for shading.'
  },
  {
    name: 'Pattern',
  ...
  },
  {
    name: 'Peeling',
    definition:
      'A&nbsp;film of paint or coating lifting from the surface due to poor adhesion. It typically applies to large pieces. See also: Chipping.'
  },
  {
    name: 'Permeability',
    definition:
  ...
  },
  {
    name: 'Phosphatizing',
    definition:
      'Steel pretreatment by a chemical solution containing metal phosphates and phosphoric acid to inhibit corrosion temporarily.'
  },
  {
    name: 'Pickling',
    definition:
      'The treatment of steel to remove rust and mill scale by immersion in a hot acid solution containing an inhibitor.'
  },
  {
    name: 'Pigment',
    definition:
  ...
  },
  {
    ...
    definition:
      'The percent by volume occupied by a pigment in the dried film of paint. It is generally expressed as a percentage.'
  },
  {
    name: 'Pinholing',
    definition:
      'A film defect characterized by small, pore-like flaws in a coating that extend entirely through the film.'
  },
  {
    name: 'Plasticizer',
  ...
  },
  {
    ...
    definition:
      'A group of synthetic resins which contain repeating ester groups. It is a special type of modified alkyd resin.'
  },
  {
    name: 'Polymer',
    definition:
  ...
  },
  {
    name: 'Profile',
    definition:
      'The term used to describe the anchor pattern of a surface produced by sandblasting, acid etching, or a similar method.'
  },
  {
    name: 'Pyrometer',
  ...
  },
  {
    ...
    definition:
      'The ratio, expressed as a percent, of the quality of water vapor present in the air to the greatest amount possible at a given temperature.'
  },
  {
    name: 'Resin',
    definition:
  ...
  },
  {
    name: 'Roller',
    definition:
      'A cylinder covered with lambswool, felt, foamed plastics, or other materials used for applying paint.'
  },
  {
    name: 'Runs',
    definition:
  ...
  },
  {
    name: 'Rust',
    definition:
      'The corrosion of steel or iron is an electrochemical phenomenon wherein the base metal reverses to a lower, more stable energy state. If the corrosive environment is water or brine, the corrosion formed is commonly known as rust.'
  },
  {
    name: 'Sag Resistance',
    definition:
      'The ability of a paint to be applied at proper film thicknesses without sagging.'
  },
  {
    name: 'Sagging',
    definition:
      'The downward movement of a paint film on a vertical surface, occurring between application and drying and resulting in an uneven coating with a thick lower edge.'
  },
  {
    name: 'Salt Atmosphere',
    definition:
      'A moist, heavily ladened air with a high chloride concentration. It is used as a test for accelerated corrosion evaluations and is also present near seacoast areas.'
  },
  {
    name: 'Salt Fog Test',
    definition:
      'A cabinet designed to accelerate the corrosion process in evaluating coatings. It combines 100% humidity with a 5% salt concentration at 100° F.'
  },
  {
    name: 'Saponification',
    definition:
      'The alkaline hydrolysis of fats whereby a soap is formed. It is a typical reaction between alkyds and galvanized metals resulting in peeling.'
  },
  {
    name: 'Satin Finish',
    definition:
  ...
  },
  {
    name: 'Shelf Life',
    definition:
      'The maximum time interval that material may be kept in a usable condition during storage.'
  },
  {
    name: 'Shop Primer',
    definition:
  ...
  },
  {
    name: 'Shot Blasting',
    definition:
      'Abrasive blasting with a round iron shot or any material which retains its spherical shape for peening purposes.'
  },
  {
    name: 'Silica Sand',
    definition:
      'Clean sand made of sharp silica particles, not containing dirt or clay, used for abrasive blast cleaning.'
  },
  {
  ...
  },
  {
    name: 'Skinning',
    definition:
      'The formation of a solid membrane on the top of a liquid. It is often caused by improper lid seal, moisture contamination, a coating past its shelf life, or solvent evaporation from the top layer (usually from high-speed drying materials).'
  },
  {
  ...
  },
  {
    ...
    definition:
      'The encapsulation of solvent within a cured paint film due to improper drying conditions, resulting in a non-continuous film.'
  },
  {
  ...
  },
  {
    name: 'Specification',
    definition:
      'A&nbsp;set of instructions detailing the plan for the coating of a project.'
  },
  {
    name: 'Spray Head',
  ...
  },
  {
    name: 'SSPC-SP-1',
    definition:
      'Covers&nbsp;the requirements for the solvent cleaning of steel surfaces. A method for removing all visible oil, grease, soil, drawing and cutting compounds, and other soluble contaminants from steel surfaces. It is intended for use before the application of paint or other protective coatings.'
  },
  {
    name: 'SSPC-SP-10',
    definition:
      'Covers the requirements for near-white blast cleaning of steel surfaces by the use of abrasives. When viewed without magnification, near-white blasted surfaces shall be free of all visible oil, grease, dirt, mill scale, rust, paint, oxides, corrosion products, or any contamination.'
  },
  {
    name: 'SSPC-SP-11',
    definition:
      'Covers the requirements for power tool cleaning to produce a bare metal surface and to retain or produce a surface profile (1 mil minimum). It is suitable where a roughened, clean, bare metal surface is required, but abrasive blasting is not feasible.'
  },
  {
    name: 'SSPC-SP-2',
    definition:
      'Covers the requirements for the hand tool cleaning of steel surfaces. A method of cleaning steel surfaces by using non-power hand tools, removing all loose mill scale, loose rust, loose paint, and other loose detrimental foreign matter.'
  },
  {
    name: 'SSPC-SP-3',
    definition:
      'Covers the requirements for the power tool cleaning of steel surfaces. A method of preparing steel surfaces by using power-assisted hand tools, removing all loose mill scale, loose rust, loose paint, and other loose detrimental foreign matter.'
  },
  {
    name: 'SSPC-SP-5',
    definition:
      'Covers the requirements for white metal blast cleaning of steel surfaces by the use of abrasives. The surface shall be free of all visible oil, grease, dirt, dust, mill scale, rust, paint, oxides, corrosion products, and other contaminants when viewed without magnification.'
  },
  {
    name: 'SSPC-SP-6',
    definition:
      'Covers the requirements for commercial blast cleaning of steel surfaces by the use of abrasives. The surface shall be free of all visible oil, grease, dirt, dust, mill scale, rust, paint, oxides, corrosion products, and other contaminants when viewed without magnification.'
  },
  {
    name: 'SSPC-SP-7',
    definition:
      'Covers the requirements for brush-off blast cleaning of steel surfaces by the use of abrasives. When viewed without magnification, the surface shall be free of all visible oil, grease, dirt, dust, loose mill scale, loose rust, and loose paint.'
  },
  {
    name: 'SSPC-SP-8',
    definition:
      'Covers the requirements for the pickling of steel surfaces. A method of preparing steel surfaces by chemical reaction, electrolysis, or both. The surfaces, when viewed without magnification, shall be free of all visible mill scale and rust.'
  },
  {
  ...
  },
  {
    name: 'Surfacer',
    definition:
      'A pigmented composition for filling depressions to obtain a smooth, uniform surface before applying the finish coat.'
  },
  {
    name: 'Surfactant',
    definition:
      'An additive that reduces surface tension, thereby improving wetting or helping to disperse pigments or inhibit foam.'
  },
  {
    name: 'Suspension',
    definition:
  ...
  },
  {
    name: 'Tails',
    definition:
      'Finger-like spray patterns produced by improper gun or coating material adjustment.'
  },
  {
    name: 'Tape Time',
    definition:
      'The drying time of a coating required before masking sections for lettering or striping, after which tape will not distort the finish.'
  },
  {
    name: 'Thermocouple',
  ...
  },
  {
    name: 'Thermoplastic',
    definition:
      'Resins having the property of becoming soft upon applying heat but which regain hardness after cooling.'
  },
  {
    name: 'Thermosetting',
    definition:
  ...
  },
  {
    name: 'Thixotropic',
    definition:
      'An adjective that describes full-bodied material that undergoes a reduction in viscosity when shaken, stirred, or otherwise mechanically disturbed but readily recovers its original full-bodied condition upon standing.'
  },
  {
    name: 'Toluene',
    definition:
  ...
  },
  {
    name: 'Two-Pack',
    definition:
      'A coating supplied in two parts that must be mixed in the correct portions before use to cure.'
  },
  {
    name: 'Undercoat',
    definition:
  ...
  },
  {
    ...
    definition:
      'Corrosion that occurs under films in the form of randomly distributed hairlines. It typically occurs when metal is corroding beneath the coating and/or at holidays, pinholes, and breaks in the coating. It can also occur when there is blistering, corrosion and/or delamination of the coating.'
  },
  {
    name: 'Vapor Barrier',
    definition:
      'A&nbsp;moisture-impervious layer that prevents the passage of water into a material or structure.'
  },
  {
  ...
  },
  {
    name: 'Vehicle',
    definition:
      'The liquid portion of a paint in which the pigment is dispersed. It is comprised of binder and thinner.'
  },
  {
  ...
  },
  {
    name: 'Viscometer',
    definition:
      "One of several types of instrument for measuring a liquid's viscosity."
  },
  {
    name: 'Viscosity',
  ...
  },
  {
    ...
    definition:
      'A&nbsp;measurement of the total amount of organic compounds evaporating from a coating film, excluding water. It is measured in pounds per gallon (lb/gal) or grams per liter (g/L).'
  },
  {
    name: 'Volume Solids',
    definition:
      'The volume of the nonvolatile portion of a composition divided by the total volume. It is expressed as a percent used to calculate the coverage rate.'
  },
  {
    name: 'Wash Primer',
    definition:
  ...
  },
  {
    ...
    definition:
      'The incorporation of water into the sandblasting operation to minimize dust.'
  },
  {
    name: 'Wetting',
    definition:
      'The ability of a vehicle to flow onto the surface to achieve a good bond.'
  },
  {
    name: 'White Rust',
  ...
  },
  {
    ...
    definition:
      'The film remaining after a solvent evaporates.&nbsp;Measured with magnetic pull off and/or electronic gauges.'
  },
  {
    name: 'Distinction of Image (DOI)',
    definition:
      'The property of a finish which describes its ability to reflect an image with clarity. This is particularly important in automotive and floor finishes. Largely determined by how well a coating flows and levels to create a very smooth surface.'
  },
  {
    name: 'Metamerism',
    definition:
      'The different appearance of color under different light sources. See: <a href="https://www.carboline.com/solution-spot/posts/understanding-metamerism-color-matching-for-industrial-coatings/">Understanding Metamerism</a>.'
  },
  {
    name: 'Surface Tolerant',
    definition:
      'A coating that is&nbsp;tolerant of less than ideal surface preparation.'
  },
  {
    name: 'Moisture Tolerant',
    definition:
      'A coating that cures and adheres to damp surfaces. It can get wet before full cure.'
  },
  {
    name: 'Mix Ratio',
    definition:
      'Typically the ratio by volume of Part A to Part B. Some coatings have more components - Parts C, D, etc.'
  },
  {
    name: 'Fisheye',
    definition:
      'Separation and/or wet film pulling apart, exposing the coating or substrate beneath.&nbsp;Often caused by contamination on substrate (silicone, oil, grease, water etc.), incompatible coatings (latex and/or waterborne coatings over silicone) or coating over sealants prior to their proper cure.'
  },
  {
    name: 'Wrinkling',
    definition:
      'A rough, crinkled surface. It is often caused by the top surface of coating drying faster than the underlying coating, excessive film build, or application when it’s too hot or windy. It most commonly occurs with oil-based (alkyd) coatings that are too thick.'
  },
  {
    name: 'Pinpoint Rusting',
    definition:
      'Rusting at pinholes, holidays, valleys, or low spots in the coating. It is often caused by pinholes exposing the substrate, insufficient coating thickness, or a surface profile too deep for a coating to sufficiently cover peaks. It is sometimes seen with WB primers or DTM’s that can not overcome surface contaminants.'
  }
];
